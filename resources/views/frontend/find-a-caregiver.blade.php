        ...
        <div class="container">
            <div class="hero-alt-content">
                <div class="hero-alt-image">
                    <img src="{{ asset('001.jpg') }}" alt="Healthcare professionals">
                </div>
                <div class="hero-alt-text">
                    <h1>Personalized in-home care with professional caregivers</h1>
                    <p style="font-size: 19px">High-quality, affordable in-home care to age in place and support independence. Get peace of mind by finding the right caregiver.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="two-column-section">
                <div class="text-column">
                    <h3>Our services</h3>
                    <p>NuviaCare can help with daily living activities for seniors to age in place, manage ongoing health challenges, and provide respite for anyone who needs a little help—our caregivers offer a wide range of services and skills to meet your needs.
...
Find a caregiver you can trust, get started here.</p>
                </div>
                <div class="image-wrapper" style="border-radius: 15px 50px 30px 5px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('003.jpg') }}" alt="Technology" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            </div>
        </div>
    </section>
...
<section style="background: linear-gradient(135deg, #e8f5f3 0%, #d9ede9 100%); padding: 80px 20px; position: relative; overflow: hidden;">
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <div style="text-align: center; margin-bottom: 60px;">
            ...
            <p style="font-size: 18px; color: #6a7a76; max-width: 800px; margin: 0 auto; line-height: 1.6;">NuviaCare has a unique solution set tailored to help reach your goals and deliver positive outcomes.</p>
        </div>

        <!-- Cards Container -->
        <div style="display: flex; gap: 40px; flex-wrap: wrap; justify-content: center; position: relative; z-index: 2;">
            
            <!-- Card 1: Companion and home helper -->
            <div style="background: white; border-radius: 24px; padding: 40px 45px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); flex: 1; min-width: 320px; max-width: 480px;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 30px;">
                    <div style="background: linear-gradient(135deg, #e0f2f1 0%, #d0e9e6 100%); width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#1a5c52" stroke-width="1.5">
                    ...
                    <h3 style="font-size: 26px; color: #1a5c52; margin: 0; font-weight: 400; font-family: Georgia, serif; line-height: 1.3;">Companion and home helper</h3>
                </div>
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="color: #5a6c68; font-size: 17px; margin-bottom: 16px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: #1a5c52;">•</span>
                        Companionship
                    </li>
                    <li style="color: #5a6c68; font-size: 17px; margin-bottom: 16px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: #1a5c52;">•</span>
                    ...
                    <li style="color: #5a6c68; font-size: 17px; margin-bottom: 0; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: #1a5c52;">•</span>
                        Light housekeeping
                    </li>
                </ul>
            ...
            <div style="background: white; border-radius: 24px; padding: 40px 45px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); flex: 1; min-width: 320px; max-width: 480px;">
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 30px;">
                    ...
                    <h3 style="font-size: 26px; color: #1a5c52; margin: 0; font-weight: 400; font-family: Georgia, serif; line-height: 1.3;">Personal care and professional caregiver</h3>
                </div>
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="color: #5a6c68; font-size: 17px; margin-bottom: 16px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: #1a5c52;">•</span>
        ...
        <!-- Decorative Circle -->
        <div style="position: absolute; bottom: -180px; left: 50%; transform: translateX(-50%); width: 450px; height: 450px; background: linear-gradient(135deg, #00bfa5 0%, #00a89a 100%); border-radius: 50%; z-index: 1;"></div>
        <div style="position: absolute; top: -100px; right: 50px; width: 180px; height: 180px; background: #1a5c52; border-radius: 50%; z-index: 1; opacity: 0.8;"></div>
    ...
    <section class="content-section" style="background: white;">
        <div class="container">
             <div  class="two-column-section ">
                ...
                <div class="image-wrapper" style="border-radius: 15px 50px 30px 5px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('008.jpg') }}" alt="Technology" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
                 <div class="text-column">
                    <h3>Care you can afford</h3>
