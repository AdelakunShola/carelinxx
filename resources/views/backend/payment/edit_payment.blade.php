                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="payment_method" name="payment_method" class="form-control">
                                            ...
                                            <option value="CashApp" {{ old('payment_method', $payment->payment_method) == 'CashApp' ? 'selected' : '' }}>CashApp</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="crypto_type" name="crypto_type" class="form-control">
                                            ...
                                            <option value="TRC20" {{ old('crypto_type', $payment->crypto_type) == 'TRC20' ? 'selected' : '' }}>TRC20</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-12">
