        ...
        <div class="container">
            <div class="header-content">
                ...
                <div class="header-right">
                    <a href="tel:{{ $settings->company_phone }}" class="phone">{{ $settings->company_phone ?? '+234 123 456 7890' }}</a>
        ...
        <div class="container">
            <div class="login-footer-content">
                <div class="contact-info">
                    <h3>Contact</h3>
                    <p>Toll-free: <a href="tel:{{ $settings->company_phone }}">{{ $settings->company_phone ?? '+234 123 456 7890' }}</a></p></p>
