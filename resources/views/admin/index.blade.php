...
<main class="flex-1 overflow-y-auto p-4 md:p-6">
    ...
    <div class="rounded-lg border bg-card text-card-foreground shadow-sm transition-all hover:shadow-md">
        ...
        <div class="p-4 md:p-6 pt-0">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold">{{ $stats['delivered_today'] }}</div>
                    <p class="text-xs text-muted-foreground mt-1">Successful deliveries</p>
                </div>
                <div class="flex items-center space-x-2">
                    @if($stats['delivered_today_growth'] >= 0)
                        <span class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80 text-green-600 bg-green-50">
                            +{{ $stats['delivered_today_growth'] }}%
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up h-4 w-4 text-green-500" aria-hidden="true">
                            <path d="M16 7h6v6"></path>
                            <path d="m22 7-8.5 8.5-5-5L2 17"></path>
            ...
            <div class="p-4 md:p-6 pt-0">
                <div class="space-y-4">
                    ...
                    @endforelse
							...
							<div class="hidden md:grid gap-6 md:grid-cols-3" data-aria-hidden="true" aria-hidden="true">
								<div class="rounded-lg border bg-card p-6 shadow-sm">
									<h3 class="text-lg font-semibold mb-4">Performance Highlights</h3>
									<div class="space-y-3">
										<div class="flex justify-between items-center"><span class="text-sm text-muted-foreground">On-time Delivery Rate</span><span class="font-medium text-green-600">94.2%</span></div>
										<div class="flex justify-between items-center"><span class="text-sm text-muted-foreground">Customer Satisfaction</span><span class="font-medium text-green-600">4.8/5.0</span></div>
										<div class="flex justify-between items-center"><span class="text-sm text-muted-foreground">Average Delivery Time</span><span class="font-medium">2.3 days</span></div>
										<div class="flex justify-between items-center"><span class="text-sm text-muted-foreground">Cost per Mile</span><span class="font-medium">$1.85</span></div>
									</div>
								</div>
								<div class="rounded-lg border bg-card p-6 shadow-sm">
									<h3 class="text-lg font-semibold mb-4">Top Routes</h3>
									<div class="space-y-3">
										<div class="flex justify-between items-center"><span class="text-sm">NY → LA</span><span class="text-sm font-medium">24 shipments</span></div>
										<div class="flex justify-between items-center"><span class="text-sm">Chicago → Houston</span><span class="text-sm font-medium">18 shipments</span></div>
										<div class="flex justify-between items-center"><span class="text-sm">Miami → Atlanta</span><span class="text-sm font-medium">15 shipments</span></div>
										<div class="flex justify-between items-center"><span class="text-sm">Seattle → Portland</span><span class="text-sm font-medium">12 shipments</span></div>
									</div>
								</div>
								<div class="rounded-lg border bg-card p-6 shadow-sm">
									...
									<div class="space-y-3">
										<div class="flex items-start space-x-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-triangle-alert h-4 w-4 text-yellow-500 mt-0.5" aria-hidden="true">
												<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"></path>
												<path d="M12 9v4"></path>
												<path d="M12 17h.01"></path>
											</svg>
											<div>
												<p class="text-sm font-medium">Maintenance Due</p>
												<p class="text-xs text-muted-foreground">3 vehicles require service</p>
											</div>
										</div>
										<div class="flex items-start space-x-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock h-4 w-4 text-red-500 mt-0.5" aria-hidden="true">
												<path d="M12 6v6l4 2"></path>
												<circle cx="12" cy="12" r="10"></circle>
											</svg>
											<div>
												<p class="text-sm font-medium">Delayed Shipments</p>
												<p class="text-xs text-muted-foreground">7 shipments behind schedule</p>
											</div>
										</div>
										<div class="flex items-start space-x-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-package h-4 w-4 text-blue-500 mt-0.5" aria-hidden="true">
												<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"></path>
												<path d="M12 22V12"></path>
												<polyline points="3.29 7 12 12 20.71 7"></polyline>
												<path d="m7.5 4.27 9 5.15"></path>
											...
											<div>
												<p class="text-sm font-medium">Low Inventory</p>
												<p class="text-xs text-muted-foreground">2 warehouses need restocking</p>
											</div>
										</div>
									</div>
								</div>
